...
if __name__ == "__main__":
    ...
    experiments_benchmark = [
        {
            "command": f'"{tensorboard_path}" --logdir=runs --port=6006 --host=localhost'
        },
        {
            "command": f'"{python_path}" train.py --model all_model --backbone cbam --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 64 --feature_dim 128 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        },
        {
            "command": f'"{python_path}" train.py --model all_model --backbone spatial --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 64 --feature_dim 128 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        },
        {
    ...
    experiments_train = [
        ...
        {
            "command": f'"{python_path}" train.py --model all_model --backbone cbam --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 64 --feature_dim 64 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        },
        {
            "command": f'"{python_path}" train.py --model all_model --backbone cbam --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 128 --feature_dim 128 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        },
        {
            "command": f'"{python_path}" train.py --model all_model --backbone cbam --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 64 --feature_dim 256 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        },
        {
            "command": f'"{python_path}" train.py --model all_model --backbone cbam --distance_type euclidean '
                      f'--in_channels 5 --hidden_dim 32 --feature_dim 128 --dropout 0.3 '
                      f'--scheduler cosine --warmup_epochs 5 --warmup_start_lr 1e-6 --lr 0.001'
        }   
    ]
    # 执行实验
